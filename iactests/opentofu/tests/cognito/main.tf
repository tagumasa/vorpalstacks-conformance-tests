...
resource "aws_cognito_identity_pool" "basic" {
  identity_pool_name               = "tf-test-identity-pool"
  allow_unauthenticated_identities = true
}

resource "aws_cognito_user_pool" "basic" {
...
data "aws_cognito_user_pool" "basic" {
  user_pool_id = aws_cognito_user_pool.basic.id
}

data "aws_cognito_identity_pool" "basic" {
  identity_pool_name = aws_cognito_identity_pool.basic.identity_pool_name
}
