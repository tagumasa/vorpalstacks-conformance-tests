...
resource "aws_sns_topic" "basic" {
  name = "tf-test-basic-topic"
}

resource "aws_sns_topic" "with_policy" {
  name = "tf-test-policy-topic"
...
resource "aws_sns_topic" "with_tags" {
  name = "tf-test-tagged-topic"
...
data "aws_sns_topic" "basic" {
  name = aws_sns_topic.basic.name
}

data "aws_sns_topic" "with_policy" {
  name = aws_sns_topic.with_policy.name
}

data "aws_sns_topic" "with_tags" {
  name = aws_sns_topic.with_tags.name
}
